package com.spring.henallux.CarPartsShop.configuration;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/", "/register/**", "/company", "/cart", "/cart/modifyQuantity","/category/**","/product/**","/css/**", "/images/**", "/404"};
