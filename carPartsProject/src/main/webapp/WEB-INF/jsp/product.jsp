...
<html>
    <body>
        <div id="product_view">
            <div class="path"><a href="<spring:url value="/home"/>">Home</a> > <a href="<spring:url value="/category/${Product.category.categoryId}"/>">${Product.category.name}</a> > <a href="<spring:url value="/product/${Product.id}"/>">...</a></div>
            <div id="leftCol">
